...
function cancel()
{
    document.forms['frm'].action='../staffalumnigallery.php';
...
$conn=mysqli_connect('localhost','root','','college_website');
  if(isset($_POST['upload']))
  {
    ...
    move_uploaded_file($_FILES["image"]["tmp_name"], "../images/alumnigallery/".$_FILES["image"]["name"]);
    $sql="INSERT INTO `alumni_gallery`(`image`,`Branch`) VALUES ('$upload_file','$department')";
