  ...
  <div id="header" class="clear">
    <div class="fl_left">
      ...
      <tr>
       ...
       <p align="right" style="color:rgba(94, 255, 0, 0.897)">HOD</p>
      </td>
    </tr>
    </table>
    </div>
...
<div class="wrapper row2">
  <div id="topnav">
    <ul>
      <li class="active"><a href="staffmainpage.php"><i class="fa fa-home"></i>Home</a></li>
      <li><a href="#">About Us</a>
        <ul>
          <li><a href="staffmainpage.php#about">About</a></li>
      ...
      <li><a href="#">Departments</a>
        <ul>
          ...
          <li><a href="office.php ">OFFICE ADMINISTRATIONS</a></li>
        </ul>
      </li>
      ...
      <li  class="last"><a href=""  style="color:red;">Settings</a>
        <ul>
          <li><a href="staffregistration.php">Add Staff</a></li>
          <li><a href="staffedit.php">Edit Staff</a></li>
          <li><a href="staffalumniaproval1.php">Alumni Registration</a></li>
          <li><a href="staffalumnigallery.php">Edit Alumni Gallery</a></li>
          <form method="post" action="">
          <li><a name="passreset" href="passreset.php">Change password</a></li></form>
