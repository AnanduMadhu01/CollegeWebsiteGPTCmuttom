...
<div class="form-group">
  ...
  <?php
    ...
    $sql="select * from `alumni_registration` where `Branch`='$branch' && `Aproval`='notapproved'";
    $result = getData($sql);
...
<table  align="center">
<tr>
<th align="center" colspan="12" style="background-color:lightblue;color:black;"><h3><div align="center">Alumni Registration List</h3></div></th>
</tr>
...
<tr>
      ...
      <td><a href="alumniaproval.php?id=<?php echo $row['Id'] ?>">Approve</a></td>
