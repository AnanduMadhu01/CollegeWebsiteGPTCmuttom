...
function add()
{
    document.forms['cform'].action='functions/addimagealumni.php';
    document.forms['cform'].submit();
}
</script>
<style>
...
.btnnew:hover{
    ...
    <body>
        ...
        <div class="gallery" align="center">
            ...
            $sql="SELECT * FROM `alumni_gallery` WHERE `Status`='active' AND `Branch`='$department'";
...
?>
            <figure>
            <a href="images/alumnigallery/<?php echo $row['image'];?>"><img src="images/alumnigallery/<?php echo $row['image'];?>" alt="Alumni Images"></a>     
            <figcaption><a class="btn" href="functions/deletealumniimage.php?id=<?php echo $row['id'] ?>">Delete</a></figcaption>
            </figure>
            <?php
 }
}
